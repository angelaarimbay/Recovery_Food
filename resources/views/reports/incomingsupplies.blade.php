...
<style>
    ...
    <p class="date">Date exported:
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td  style="width: 10%;"> {{ $items['category_details']['supply_cat_name'] }} </td>   
                ...
                <td  style="width: 10%;"> {{ $items['format_amount'] }} </td>
                <td  style="width: 10%;"> {{ date("Y-m-d", strtotime( $items['incoming_date'])) }} </td>   
            </tr>  
        @endforeach
        </table>
    </body>
