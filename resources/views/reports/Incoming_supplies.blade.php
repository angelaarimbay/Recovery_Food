...
<style>
  ...
  font: 12pt "Tahoma";
    ...
    <div style="padding-left: 42%; padding-top: -30;">   
     ...
     <p class="incomingreport">Incoming Supplies  Report</p>
...
<tr>
    ...
    <td  style="width: 20%;">   {{ $items['quantity_amount']  }} </td>
    <td  style="width: 20%;">  {{ date("Y-m-d", strtotime( $items['incoming_date'])) }} </td>   
